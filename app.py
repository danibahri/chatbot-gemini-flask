...
# Defines a route for the home page (/) that sends the index.html file from the template directory.
@app.route('/')
def home():
...
# Defines a route to serve static files from the static directory for any given path.
# When a request matches the path, it sends the requested file from the static directory.
@app.route('/<path:path>')
